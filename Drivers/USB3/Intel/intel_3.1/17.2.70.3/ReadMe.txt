Intel® USB 3.1 eXtensible Host Controller v17.2.70.x - Release Notes
=============================================================================
This package provides drivers for Titan Ridge USB3.1 Controller for Windows* 7, namely including:
...
Pre-requisites 
==============
 - Intel USB3.0/3.1 driver package (separately available) should be installed as well on the system 
